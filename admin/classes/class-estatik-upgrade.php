...
class Estatik_Upgrader
{
    ...
    public function run()
    {
        if ( ! class_exists( 'ZipArchive' ) ) {
            $this->_messenger->set_message( __( 'Please, install zip extension for PHP. http://php.net/manual/ru/book.zip.php' ), 'error' );
        ...
        if ( $upload ) {
            ...
            if ( ! $valid ) {
                $this->_messenger->set_message( __( 'Invalid array structure. The Archive should not consist plugin sub folder in archive.' ), 'error' );
            ...
            try {
                ...
                $this->_messenger->set_message( __( 'Estatik successfully upgraded!' ), 'success' );
