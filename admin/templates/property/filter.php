<div class="es-property-list-filter es-box">
    ...
    <div class="es-input-row">
        ...
        <input type="submit" class="es-button es-button-blue es-submit-filter" value="Search"/>
    ...
    <div class="es-manage-row">
        ...
        <button type="submit" data-error="<?php _e( 'Please select properties you want to copy.', 'es-plugin' ); ?>" data-confirm="<?php _e( 'Are you sure you want to copy these items?', 'es-plugin' ); ?>" data-action="copy" class="es-button es-button-gray es-button-copy js-es-copy"><?php _e( 'Copy', 'es-plugin' ); ?></button>
        <button type="submit" data-error="<?php _e( 'Please select properties you want to delete.', 'es-plugin' ); ?>" data-confirm="<?php _e( 'Are you sure you want to delete these items?', 'es-plugin' ); ?>" data-action="delete" class="es-button es-button-gray es-button-delete js-es-delete"><?php _e( 'Delete', 'es-plugin' ); ?></button>
        <button type="submit" data-error="<?php _e( 'Please select properties you want to publish.', 'es-plugin' ); ?>" data-confirm="<?php _e( 'Are you sure you want to publish these items?', 'es-plugin' ); ?>" data-action="publish" class="es-button es-button-gray es-button-publish js-es-publish"><?php _e( 'Publish', 'es-plugin' ); ?></button>
        <button type="submit" data-error="<?php _e( 'Please select properties you want to unpublish.', 'es-plugin' ); ?>" data-confirm="<?php _e( 'Are you sure you want to unpublish these items?', 'es-plugin' ); ?>" data-action="unpublish" class="es-button es-button-gray es-button-unpublish js-es-unpublish"><?php _e( 'Unpublish', 'es-plugin' ); ?></button>
    </div>
